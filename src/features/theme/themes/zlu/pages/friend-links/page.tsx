  ...
  return (
    ...
    >
      ...
      <div className="zlu-friend-info min-w-0 flex-1">
        <h3 className="zlu-friend-name group-hover:text-[var(--zlu-primary)] transition-colors truncate">
          {link.name}
        </h3>
      ...
      <ArrowUpRight className="w-5 h-5 text-[var(--zlu-text-tertiary)] group-hover:text-[var(--zlu-primary)] transition-colors flex-shrink-0" />
    </a>
  );
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-6">
        <h1 className="text-3xl font-bold mb-2 text-[var(--zlu-text-primary)]">友情链接</h1>
        <p className="text-[var(--zlu-text-secondary)]">志同道合的站点，彼此链接，互相照亮</p>
      </div>
      ...
      {links.length > 0 ? (
        ...
        <div className="text-center py-12 zlu-sidebar-card">
          <Users className="w-12 h-12 text-[var(--zlu-text-tertiary)] mx-auto mb-4" />
          <p className="text-[var(--zlu-text-secondary)]">暂无友链</p>
        </div>
      )}

      {/* Submit CTA */}
      {links.length > 0 && (
        <div className="border-t border-[var(--zlu-border)] pt-8">
          <div className="text-center space-y-4">
            <h3 className="text-lg font-semibold text-[var(--zlu-text-primary)]">加入我们</h3>
